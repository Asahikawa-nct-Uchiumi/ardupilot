...
class ModeArmTip : public Mode {

public:
    // inherit constructor
    using Mode::Mode;
    Number mode_number() const override { return Number::ARM_TIP; }
...
protected:
    ...
    const char *name() const override { return "ARM_TIP"; }
    const char *name4() const override { return "AMTP"; }
